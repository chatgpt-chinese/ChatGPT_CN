# ChatGPT 中文版：国内访问指南~（支持 GPT-4、GPT-4o、GPT-o1 和 GPT-o3，无需翻墙）
...
[**ChatGPT 中文版**](https://chat.lanjingai.org) 是 OpenAI 开发的 ChatGPT 模型的中文版本，专为中文用户设计，提供更流畅、更精准的 AI 对话体验。
...
- [https://chat.lanjing.pro](https://chat.lanjingai.org/) - **ChatGPT 中文站**，支持 GPT-4o、o1、o3 及 DeepSeek R1、Claude 4 sonnet、Grok 3 最先进的模型，无限使用~
